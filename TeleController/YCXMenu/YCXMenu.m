...
- (void)showMenuInView:(UIView *)view fromRect:(CGRect)rect menuItems:(NSArray *)menuItems selected:(YCXMenuSelectedItem)selectedItem {
    ...
    if (_arrowDirection == YCXMenuViewArrowDirectionDown) {
        toFrame.origin.y -= 10;
    }
    
    self.frame = (CGRect){self.arrowPoint, 1, 1};
    
    [[NSNotificationCenter defaultCenter] postNotificationName:YCXMenuWillAppearNotification object:[NSNumber numberWithInt:_arrowDirection]];
